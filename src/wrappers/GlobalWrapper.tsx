  ...
  const createStore = React.useCallback(
    async ({
      ...
      try {
        ...
        let metadescription =
          `**coins:QORTtrue,ARRR${supportedCoins.includes("ARRR")},BTC${supportedCoins.includes("BTC")},LTC${supportedCoins.includes("LTC")},DOGE${supportedCoins.includes("DOGE")},DGB${supportedCoins.includes("DGB")},RVN${supportedCoins.includes("RVN")}**` +
